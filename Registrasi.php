...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	  <a class="navbar-brand" href="#">Pengembangan Aplikasi Berbasis Web</a>
	...
	<div class="container p-5">
		...
		<form method="post" action="Action.php">
			...
			<div class="form-group mb-2">
			<input type="password" name="repass" required="" placeholder="Konfirmasi Password" class="form-control">
			</div>
			<div class="form-group mb-2">
			<input type="submit" name="create" value="Daftar" class="btn btn-primary p-2">
			</div>
		</form>
	</div>
